        ...
        <div class="!pb-4 flex justify-between">
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <form action="{{ route('offerings') }}" method="get">
                        <input type="text" id="search" name="search"
                            class="block !pt-2 ps-10 !text-sm text-gray-900 !border !border-gray-300 !rounded-lg w-80 !bg-gray-50 focus:!ring-blue-500 focus:!border-blue-500"
                            placeholder="Buscar Tipo de Ofrenda">
                    </form>
                </div>
            </div>
            <div>
                    ...
                    @foreach ($offeringsTypes as $offering)
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4 flex flex-col">
                                <a href="{{ route('offerings.show', $offering->id) }}"
                                        ...
                                        <div x-show="modalOpen"
                                            ...
                                            <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen"
                                                ...
                                                <div class="flex items-center justify-between pb-2">
                                                    <h3 class="text-lg font-semibold">Eliminar Ofrenda</h3>
                                                ...
                                                <div class="relative w-auto pb-8">
                                                    <p>¿Estas seguro de eliminar este tipo de ofrenda? Esta accion no se
                                                        puede deshacer.</p>
                                                </div>
                                                <div class="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                                                    ...
                                                    <form action="{{ route('offerings.destroy') }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <input type="hidden" name="offeringType"
                                                            value="{{ $offering->id }}">
                                                        <button type="submit"
